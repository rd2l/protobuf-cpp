...
#ifndef PROTOBUF_steammessages_5fsecrets_2esteamclient_2eproto__INCLUDED
#define PROTOBUF_steammessages_5fsecrets_2esteamclient_2eproto__INCLUDED
...
class CKeyEscrow_Request : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.steam.CKeyEscrow_Request) */ {
 public:
  CKeyEscrow_Request();
  ...
  inline CKeyEscrow_Request* New() const PROTOBUF_FINAL { return New(NULL); }

  CKeyEscrow_Request* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class CKeyEscrow_Ticket : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.steam.CKeyEscrow_Ticket) */ {
 public:
  CKeyEscrow_Ticket();
  ...
  inline CKeyEscrow_Ticket* New() const PROTOBUF_FINAL { return New(NULL); }

  CKeyEscrow_Ticket* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class CKeyEscrow_Response : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.steam.CKeyEscrow_Response) */ {
 public:
  CKeyEscrow_Response();
  ...
  inline CKeyEscrow_Response* New() const PROTOBUF_FINAL { return New(NULL); }

  CKeyEscrow_Response* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
template <> struct is_proto_enum< ::proto::steam::EKeyEscrowUsage> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_steammessages_5fsecrets_2esteamclient_2eproto__INCLUDED
