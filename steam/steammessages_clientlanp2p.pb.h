...
namespace google {
namespace protobuf {
template<> ::proto::steam::CMsgClientLANP2PRequestChunks* Arena::CreateMaybeMessage<::proto::steam::CMsgClientLANP2PRequestChunks>(Arena*);
template<> ::proto::steam::CMsgClientLANP2PRequestChunksResponse* Arena::CreateMaybeMessage<::proto::steam::CMsgClientLANP2PRequestChunksResponse>(Arena*);
template<> ::proto::steam::CMsgClientLANP2PRequestChunksResponse_ChunkData* Arena::CreateMaybeMessage<::proto::steam::CMsgClientLANP2PRequestChunksResponse_ChunkData>(Arena*);
template<> ::proto::steam::CMsgClientLANP2PRequestChunks_ChunkKey* Arena::CreateMaybeMessage<::proto::steam::CMsgClientLANP2PRequestChunks_ChunkKey>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace proto {
namespace steam {
...
class CMsgClientLANP2PRequestChunks_ChunkKey final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.steam.CMsgClientLANP2PRequestChunks.ChunkKey) */ {
 public:
...
class CMsgClientLANP2PRequestChunks final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.steam.CMsgClientLANP2PRequestChunks) */ {
 public:
...
class CMsgClientLANP2PRequestChunksResponse_ChunkData final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.steam.CMsgClientLANP2PRequestChunksResponse.ChunkData) */ {
 public:
...
class CMsgClientLANP2PRequestChunksResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.steam.CMsgClientLANP2PRequestChunksResponse) */ {
 public:
