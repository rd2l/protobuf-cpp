...
#ifndef PROTOBUF_INCLUDED_dota_5fclient_5fenums_2eproto
#define PROTOBUF_INCLUDED_dota_5fclient_5fenums_2eproto
...
template <> struct is_proto_enum< ::proto::dota::ETournamentTemplate> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::dota::ETournamentTemplate>() {
  return ::proto::dota::ETournamentTemplate_descriptor();
}
template <> struct is_proto_enum< ::proto::dota::ETournamentGameState> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::dota::ETournamentGameState>() {
  return ::proto::dota::ETournamentGameState_descriptor();
}
template <> struct is_proto_enum< ::proto::dota::ETournamentTeamState> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::dota::ETournamentTeamState>() {
  return ::proto::dota::ETournamentTeamState_descriptor();
}
template <> struct is_proto_enum< ::proto::dota::ETournamentState> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::dota::ETournamentState>() {
  return ::proto::dota::ETournamentState_descriptor();
}
template <> struct is_proto_enum< ::proto::dota::ETournamentNodeState> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::dota::ETournamentNodeState>() {
  return ::proto::dota::ETournamentNodeState_descriptor();
}
template <> struct is_proto_enum< ::proto::dota::EDOTAGroupMergeResult> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::dota::EDOTAGroupMergeResult>() {
  return ::proto::dota::EDOTAGroupMergeResult_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_dota_5fclient_5fenums_2eproto
