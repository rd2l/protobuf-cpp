...
template <> struct is_proto_enum< ::proto::dota::EGCSystemMsg> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::dota::EGCSystemMsg>() {
  return ::proto::dota::EGCSystemMsg_descriptor();
}
template <> struct is_proto_enum< ::proto::dota::ESOMsg> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::dota::ESOMsg>() {
  return ::proto::dota::ESOMsg_descriptor();
}
template <> struct is_proto_enum< ::proto::dota::EGCBaseClientMsg> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::dota::EGCBaseClientMsg>() {
  return ::proto::dota::EGCBaseClientMsg_descriptor();
}
template <> struct is_proto_enum< ::proto::dota::EGCToGCMsg> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::dota::EGCToGCMsg>() {
  return ::proto::dota::EGCToGCMsg_descriptor();
}
