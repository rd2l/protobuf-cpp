...
#ifndef PROTOBUF_INCLUDED_dota_5fgcmessages_5fmsgid_2eproto
#define PROTOBUF_INCLUDED_dota_5fgcmessages_5fmsgid_2eproto
...
const EDOTAGCMsg EDOTAGCMsg_MAX = k_EMsgGCToGCReconcileEventOwnership;
...
template <> struct is_proto_enum< ::proto::dota::EDOTAGCMsg> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::dota::EDOTAGCMsg>() {
  return ::proto::dota::EDOTAGCMsg_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_dota_5fgcmessages_5fmsgid_2eproto
