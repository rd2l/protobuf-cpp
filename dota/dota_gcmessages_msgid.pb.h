...
const EDOTAGCMsg EDOTAGCMsg_MAX = k_EMsgServerToGCMatchPlayerItemPurchaseHistory;
...
template <> struct is_proto_enum< ::proto::dota::EDOTAGCMsg> : ::google::protobuf::internal::true_type {};
template <>
